...
No API key needed - uses your existing Claude Code plan!
...
'''
    ...
    def _run_headless(self, prompt_file, timeout):
        ...
        try:
            # Run claude-internal command directly (this WAITS for completion)
            print("   Running: claude-internal {prompt_file}")
            print("   ⏳ Please wait...")
            print()
            ...
            print("❌ 'claude-internal' command not found")
            print()
